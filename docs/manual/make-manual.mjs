...
step(1, "เข้าสู่ระบบ");
para(
  "เปิดหน้าเว็บของระบบ แล้วเข้าสู่ระบบด้วยบัญชีที่ผู้ดูแลกำหนดให้ — ปุ่มที่เห็นขึ้นกับที่ผู้ดูแลตั้งค่าไว้ " +
    "อาจเป็น Microsoft, CMU Account หรือบัญชีสาธิตชั่วคราว เมื่อเข้าสำเร็จระบบจะพาไปหน้าแชททันที",
);
